...
namespace Engine
{
  ...
  namespace UI
  {
    ...
    {
    public:
      static std::shared_ptr<DraggableBase> Create(std::shared_ptr<UILayer> ThisLayer, std::shared_ptr<WidgetHelper> ThisHelper, const sf::Vector2f &Position, const sf::Vector2f &Size);
