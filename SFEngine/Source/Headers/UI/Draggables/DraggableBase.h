...
namespace Engine
{
  ...
  namespace UI
  {
    ...
    {
    public:
      static std::shared_ptr<DraggableBase> Create(std::weak_ptr<UILayer> ThisLayer, std::weak_ptr<WidgetHelper> ThisHelper, const sf::Vector2f &Position, const sf::Vector2f &Size);
